...
# === umunandi.dev setup script ===
# Configures the VVV VM to create the umunandi.dev development server
...
# Prepare the umunandi.dev WordPress site using VVV's auto site setup method
